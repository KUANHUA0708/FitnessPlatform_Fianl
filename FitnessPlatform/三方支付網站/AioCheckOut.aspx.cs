...
namespace FitnessPlatform.三方支付網站
{
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            try
            {
                using (AllInOne oPayment = new AllInOne())
                {
                    ...
                    oPayment.Send.TotalAmount = Decimal.Parse("9880");//交易總金額
                    ...
                    {
                        Name = "Fitness Santé 特選優惠方案<八堂>　",//商品名稱
                        Price = Decimal.Parse("1500"),//商品單價
                        Currency = "新台幣",//幣別單位
                        Quantity = Int32.Parse("8"),//購買數量
